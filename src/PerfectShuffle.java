...
public class PerfectShuffle {
	...
	private List<Card> shuffleOnce(){
		List<Card> deck1 = cards.subList(0, 26); Stack<Card> d1 = (Stack<Card>) deck1;
		List<Card> deck2 = cards.subList(26, 52);Stack<Card> d2 = (Stack<Card>) deck2;
		List<Card> newCards = new ArrayList<Card>(52);
		int remainingD1 = 26, remainingD2 = 26;
		//This is the shuffling loop
		while(remainingD1 >= 0 && remainingD2 >= 0){
